...
import com.wlgbsj.mymoblieplayer.domain.NetAudioPagerData;
...
/**
 * Created by wlgbsj on 2017/3/29  17:07.
 */
        ...
        switch (itemViewType) {
            case TYPE_VIDEO://视频
               ...
               // viewHolder.jcv_videoplayer.setUp(mediaItem.getVideo().getVideo().get(0), mediaItem.getVideo().getThumbnail().get(0), null);
                //viewHolder.jcv_videoplayer.setUp(mediaItem.getVideo().getVideo().get(0),JCVideoPlayerStandard.SCREEN_LAYOUT_DETAIL,//null);
